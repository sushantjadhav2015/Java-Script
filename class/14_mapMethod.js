...
console.log(`------Sqaure of array numbers ------------`);
...
// the output is in single line so no need to write {} bracket and aslo map automaticaly return the given value no need to write return
