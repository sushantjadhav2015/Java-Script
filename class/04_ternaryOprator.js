...
// var nameOfVar = condition check ? "sentence_1" : "sentence_2"
...
console.log(`Result is ${sscResult(23)}`);       // when you enter valid valuve then result is happy path
console.log(`Result is ${sscResult(1200)}`);      //  when you enter valid valuve then result is unhappy path
